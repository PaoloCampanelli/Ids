...
class ScontoTest {
    ...
    public void Sconto(){
        ...
        Sconto sconto =new Sconto(1, "50%", Date.from(Instant.now()), Date.from(Instant.now().plusSeconds(864000)), negozioFruttivendolo, categoriaFrutta);
        Sconto sconto2 = new Sconto(2, "20%", Date.from(Instant.now()), Date.from(Instant.now().plusSeconds(864000)), negozioFruttivendolo, categoriaMele);
